...
\author[Adam Rosien]{Adam Rosien}
...
\begin{table}[ht]
  ...
  \begin{tabular}{rl}
    ...
    \midrule
    De-construct into \texttt{Failure} and \texttt{Success} cases & \texttt{v.fold(} \\ & \texttt{  f => ...,} \\ & \texttt{  s => ...)} \\
    Combine \texttt{Validation}s & \texttt{(ValidationNEL[X, A] |@|} \\
...
\texttt{Lens} give you composable "getter/setter" objects.
